    ...
    <GuestLayout>
        ...
        <div>
            <div class="text-center mb-5">
                <h1 class="text-xl font-condensed font-bold uppercase tracking-[0.06em] text-white">NUEVA CONTRASEÑA</h1>
                <p class="text-xs text-white/30 mt-1">Elegí una contraseña nueva para tu cuenta</p>
            </div>
