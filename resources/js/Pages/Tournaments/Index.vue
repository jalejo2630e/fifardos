...
const { t } = useI18n({
    ...
    messages: {
        es: {
            ...
            subtitle: 'Gestiona tus torneos de cualquier deporte',
            ...
            emptyTodosDesc: 'Crea tu primer torneo de cualquier deporte y que empiece el partido.',
            ...
            emptySetupDesc: 'Los torneos en fase de configuración vivirán aquí. Prepara las consolas o canchas y a los participantes.',
            step1Title: 'Crea un torneo',
            step1Desc: 'Elegí el deporte, un nombre, el modo (consola o cancha) y agregá a los participantes. El fixture se genera automáticamente.',
            step2Title: 'Ingresá el marcador',
            step2Desc: 'Partido a partido, cargá el resultado (goles, puntos o sets). La tabla se actualiza sola.',
        ...
        en: {
            ...
            subtitle: 'Manage your tournaments for any sport',
            ...
            emptyTodosDesc: 'Create your first tournament for any sport and let the match begin.',
            ...
            emptySetupDesc: 'Tournaments in the setup phase will live here. Get the consoles or fields and the participants ready.',
            step1Title: 'Create a tournament',
            step1Desc: 'Pick the sport, a name, the mode (console or field) and add the participants. The fixture is generated automatically.',
            step2Title: 'Enter the score',
            step2Desc: 'Match by match, enter the result (goals, points or sets). The table updates on its own.',
