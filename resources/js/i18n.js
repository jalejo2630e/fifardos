...
const messages = {
    es: {
        ...
        landing: {
            ...
            howNote: 'Sin cuentas, sin app, sin planilla de Excel del primo que se ofende.',
            steps: [
            ...
            ctaBtn: 'Crear torneo gratis', ctaSub: 'Sin registro · sin descargas · PS5, Xbox y PC',
        ...
        mcp: {
            ...
            noteGpt: 'ChatGPT admite conectores MCP por HTTP. Exponé el servidor con un puente:',
    ...
    en: {
        ...
        landing: {
            ...
            howNote: 'No accounts, no app, no cousin\'s Excel spreadsheet that gets offended.',
            steps: [
            ...
            features: [
                ...
                { tag: 'Share', t: 'One link for the whole group', d: 'Send the link and everyone sees the table from their phone. No accounts or passwords.' },
            ...
            faqs: [
                { q: 'Do I have to sign up?', a: 'No. Create the tournament and share the link. Done.' },
            ...
            ctaBtn: 'Create tournament free', ctaSub: 'No signup · no downloads · PS5, Xbox and PC',
        ...
        mcp: {
            ...
            noteGpt: 'ChatGPT supports MCP connectors over HTTP. Expose the server with a bridge:',
