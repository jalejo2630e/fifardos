...
class SportRulesSeeder extends Seeder
{
    ...
    public static function data(): array
    {
        ...
        return [
            'fifa' => [
                self::n('tiempo_partido_min', 'Tiempo por partido (min)', 'Match time (min)', 6, 1, 20, $t, 'Duración de cada partido en la consola', 'Length of each match on the console'),
                self::b('alargue_en_eliminatorias', 'Alargue en eliminatorias', 'Extra time in knockouts', true, $t, 'Tiempo extra si hay empate', 'Extra time if tied'),
            ...
            'soccer' => [
                self::n('duracion_tiempo_min', 'Duración de cada tiempo (min)', 'Half length (min)', 45, 10, 45, $t),
                self::s('cantidad_tiempos', 'Cantidad de tiempos', 'Number of halves', '2', ['1', '2'], $t),
                self::b('tiempo_extra_habilitado', 'Tiempo extra habilitado', 'Extra time enabled', false, $t),
            ...
            'football7' => [
                self::n('duracion_tiempo_min', 'Duración de cada tiempo (min)', 'Half length (min)', 30, 10, 30, $t),
                self::s('cantidad_tiempos', 'Cantidad de tiempos', 'Number of halves', '2', ['1', '2'], $t),
                self::b('tiempo_extra_habilitado', 'Tiempo extra habilitado', 'Extra time enabled', false, $t),
                self::b('definicion_penales', 'Definición por penales', 'Penalty shootout', true, $d),
            ...
            'football6' => [
                self::n('duracion_tiempo_min', 'Duración de cada tiempo (min)', 'Half length (min)', 25, 10, 25, $t),
                self::s('cantidad_tiempos', 'Cantidad de tiempos', 'Number of halves', '2', ['1', '2'], $t),
                self::b('tiempo_extra_habilitado', 'Tiempo extra habilitado', 'Extra time enabled', false, $t),
                self::b('definicion_penales', 'Definición por penales', 'Penalty shootout', true, $d),
                self::b('fuera_de_juego', 'Fuera de juego', 'Offside', false, $g),
            ...
            'futsal' => [
                self::n('duracion_tiempo_min', 'Duración de cada tiempo (min)', 'Half length (min)', 20, 10, 20, $t),
                self::s('cantidad_tiempos', 'Cantidad de tiempos', 'Number of halves', '2', ['1', '2'], $t),
                self::b('tiempo_extra_habilitado', 'Tiempo extra habilitado', 'Extra time enabled', false, $t),
                self::b('definicion_penales', 'Definición por penales', 'Penalty shootout', true, $d),
                self::b('fuera_de_juego', 'Fuera de juego', 'Offside', false, $g),
            ...
            'basketball' => [
                self::n('cantidad_cuartos', 'Cantidad de cuartos', 'Number of quarters', 4, 2, 4, $t),
                self::n('duracion_cuarto_min', 'Duración de cada cuarto (min)', 'Quarter length (min)', 10, 5, 12, $t),
                self::n('prorroga_min', 'Prórroga (min)', 'Overtime (min)', 5, 1, 10, $t),
                self::s('reloj_posesion_seg', 'Reloj de posesión (seg)', 'Shot clock (sec)', '24', ['14', '24', 'sin_reloj'], $t),
            ...
            'basketball3' => [
                ...
                self::n('duracion_max_min', 'Duración máxima (min)', 'Max duration (min)', 10, 5, 20, $t),
                ...
                self::s('reloj_posesion_seg', 'Reloj de posesión (seg)', 'Shot clock (sec)', '12', ['12', 'sin_reloj'], $t),
            ],
            'volleyball' => [
            ...
            'handball' => [
                self::n('cantidad_tiempos', 'Cantidad de tiempos', 'Number of halves', 2, 2, 2, $t),
                self::n('duracion_tiempo_min', 'Duración de cada tiempo (min)', 'Half length (min)', 30, 10, 30, $t),
                self::b('tiempo_extra_habilitado', 'Tiempo extra habilitado', 'Extra time enabled', false, $t),
            ...
            'rugby' => [
                self::n('duracion_tiempo_min', 'Duración de cada tiempo (min)', 'Half length (min)', 40, 10, 40, $t),
