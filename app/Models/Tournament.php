...
class Tournament extends Model
{
    ...
    /**
     * Estima la duración total del torneo en minutos: partidos de grupos (todos
     * contra todos) + eliminatorias, repartidos en paralelo entre las consolas/canchas.
     */
    public static function estimateMinutes(int $players, int $consoles, int $minutesPerMatch): int
    {
